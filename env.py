...
class ClutteredPushGrasp:
    ...
    def __init__(self, models: Models, camera: Camera, vis=False, num_objs=3, gripper_type='85') -> None:
        ...
        self.tablaID = p.loadURDF("/Users/vagrant/Documents/pybullet/main_fetch/pybullet_ur5_robotiq/urdf/objects/table.urdf",
                                  # p.loadURDF("/Users/vagrant/Documents/pybullet/main_fetch/pybullet_ur5_robotiq/urdf/objects/table.urdf", ...)
                                  [0.0, -0.5, 0.8],
                                  p.getQuaternionFromEuler([0, 0, 0]),
                                  useFixedBase=True)
        self.UR5StandID = p.loadURDF("/Users/vagrant/Documents/pybullet/main_fetch/pybullet_ur5_robotiq/urdf/objects/ur5_stand.urdf",
                                     [-0.7, -0.36, 0.0],
                                     p.getQuaternionFromEuler([0, 0, 0]),
                                     useFixedBase=True)
        self.robotID = p.loadURDF("/Users/vagrant/Documents/pybullet/main_fetch/pybullet_ur5_robotiq/urdf/ur5_robotiq_%s.urdf" % gripper_type,
